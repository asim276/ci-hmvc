...
<div id="navigation">
		<div class="container-fluid" style="padding-left:0;">
			<a href="#" id="brand" style="margin:0; padding:0;"><img src="<?=base_url().'jic-repo/img/logo.jpg'?>" width="204"></a>
			...
			<ul class='main-nav'>
                ...
                <li>
					...
					<ul class="dropdown-menu">
						...
						<li>
							<a href="#">Manage Email Templates</a>
						</li>												
					</ul>
				</li>
			...
			<div class="user">
				...
				<div class="dropdown">
					<a href="#" class='dropdown-toggle' data-toggle="dropdown"><img src="<?=base_url().'jic-repo/img/demo/user-avatar.jpg'?>" alt=""></a>
