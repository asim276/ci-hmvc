...
<head>
	...
	<title>FRONT END Dubimotors - Login</title>
			...
			<form action="#" method="post" class='form-validate' id="back_admin_login">
				<div class="control-group">
					<div class="email controls">
						<input type="text" name="email_address" id="email_address" placeholder="Email address" class='input-block-level' data-rule-required="true" data-rule-email="true" autocomplete="off">
					</div>
				</div>
				<div class="control-group">
					<div class="pw controls">
						<input type="password" name="agent_password" id="agent_password" placeholder="Password" class='input-block-level' data-rule-required="true" autocomplete="off">
					</div>
				</div>
				<div class="submit">
					<div class="remember">
